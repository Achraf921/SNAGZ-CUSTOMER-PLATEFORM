...
import OuNousTrouver from "./components/pages/OuNousTrouver.jsx"; // Import OuNousTrouver component
...
const App = () => {
  ...
  } else if (pathname === "/ou-nous-trouver") {
    ComponentToRender = OuNousTrouver;
  } else if (pathname === "/qui-nous-sommes") {
    ComponentToRender = QuiNousSommes;
  }
  // Customer Routes
  else if (pathname === "/client/login") {
    // Redirect to main page with client login focus
    window.location.replace("/?portal=client");
    return null;
